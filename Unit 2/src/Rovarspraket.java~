 ...
 * @course ICS4U1
 * @date 2015/02/20
 * @description This program will translate any word into the Swedish children's language 'Rovarspraket.
 */
public class Rovarspraket 
{
	public static void main(String[] args) 
	{
		...
		{
			String output = getOutput(input.charAt(i));
 ...
 */
	public static String getOutput(char letter) 
	{
		String output = "";
		...
		//If it is a consonant, at the vowel closest and the next consonant.
